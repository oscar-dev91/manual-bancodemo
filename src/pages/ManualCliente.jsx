    ...
    <section>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-2">📸 <img src={`${import.meta.env.BASE_URL}/screenshots/login-cliente.png`} alt="pantalla de login" /> pantalla de login.</p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-2">📸 <img src={`${import.meta.env.BASE_URL}/screenshots/transferencia-cliente.png`} alt="formulario de transferencia" /> formulario de transferencia y confirmación.</p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-2">📸 <img src={`${import.meta.env.BASE_URL}/screenshots/historial-cliente.png`} alt="lista de transacciones" /> lista de transacciones con scroll.</p>
        </div>
      </div>
    </section>
  );
